...
{
LogPrintf("PlaceBetEvent::on_pushButtonPlaceHomeBet_clicked: about to print\n");
LogPrintf("PlaceBetEvent::on_pushButtonPlaceHomeBet_clicked: %s %s\n", event->id.c_str(), event->homeTeam.c_str());
    emit currentEventChanged(event, event->homeTeam, event->homeOdds);
}

void PlaceBetEvent::on_pushButtonPlaceAwayBet_clicked()
{
LogPrintf("PlaceBetEvent::on_pushButtonPlaceAwayBet_clicked: about to print\n");
LogPrintf("PlaceBetEvent::on_pushButtonPlaceAwayBet_clicked: %s %s\n", event->id.c_str(), event->awayTeam.c_str());
    emit currentEventChanged(event, event->awayTeam, event->awayOdds);
}

void PlaceBetEvent::on_pushButtonPlaceDrawBet_clicked()
{
LogPrintf("PlaceBetEvent::on_pushButtonPlaceDrawBet_clicked: about to print\n");
LogPrintf("PlaceBetEvent::on_pushButtonPlaceDrawBet_clicked: %s %s\n", event->id.c_str(), event->drawOdds.c_str());
